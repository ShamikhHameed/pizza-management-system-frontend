...
import validateInfo from '../Validation/ToppingValidation';
import '../App.css'
...
export const AddToppingModal = ({ showModal, setShowModal }) => {
    ...
    const handleSubmit = e => {
        ...
        if(Object.keys(errors).length === 0 && isSubmitting) {
            ToppingService.addTopping(name, smallPrice, veg)
        .then(
            () => {
                setShowModal(false);
                setSnackbarMessage("Topping added Successfully");
        ...
        error => {
            const resMessage =
                ...
                error.message ||
                error.toString();
            setSnackbarMessage("ERROR: Unable to add topping. " + resMessage);
                    ...
                    <ModalContent>
                        <form className="form" onSubmit={handleSubmit}>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <input id="veg" type="radio" value="veg" name="toppingType" defaultChecked/>
                                    </td>
                                    ...
                                    <td>
                                        <input id="non-veg" type="radio" value="non-veg" name="toppingType"/>
                                    </td>
                                    <td className="radioLabel">
